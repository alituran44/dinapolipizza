  ...
  const handleCredentialResponse = (response) => {
    try {
      ...
      const googleUser = {
        ...
        isGoogle: true,
        isAdmin: payload.email === 'chef.luigi@dinapolipizza.com' || payload.email === 'admin@dinapolipizza.com'
      };
      ...
      console.error("Google authentication JWT parsing failed:", e);
    }
  };
    ...
    if (isOpen && window.google) {
      ...
      if (clientId) {
        try {
          ...
          setTimeout(() => {
            const parent = document.getElementById('google-official-btn');
            if (parent) {
                  ...
                  {localStorage.getItem('dinapoli_google_client_id') || '97662071892-4e7fsue72o4ta850a2voii72rfj5qnbs.apps.googleusercontent.com' ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      ...
                      <span style={{ fontSize: '9px', color: '#94a3b8', textAlign: 'center' }}>
                        * Gerçek Google Girişi için yönetici panelinden Google Client ID tanımlayın.
                      </span>
                    </div>
                  )}
                </form>
